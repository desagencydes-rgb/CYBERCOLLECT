...
class ContrainteTemporelle:
    ...
    def est_realisable(self, camion_id: int, zone_id: int, creneau) -> bool:
        ...
        # 2. Vérification des Pauses Camion (Heuristique simplifiée)
        if camion_id in self.pauses_camion:
            for pause in self.pauses_camion[camion_id]:
                # Logique simplifiée : on vérifie si la pause commence au début du créneau
                # Une implémentation réelle vérifierait l'intersection complète.
                pass 
